...
import {
    ...
    RightCircleOutlined,
    MenuOutlined,
    DeleteOutlined, // Added for the archive icon
        ...
        <div>
            ...
            <Layout style={{ marginTop: "20px", background: '#f0f2f5' }}>
                ...
                >
                    ...
                    <Menu
                        mode="inline"
                        // Set the default selected key to 'archived_report'
                        defaultSelectedKeys={['archived_report']}
                        style={{ borderRight: 0 }}
                ...
                <Layout style={{ marginLeft: '24px', background: 'transparent' }}>
                    ...
                    >
                        {/* Centered content for archived reports */}
                        <Space direction="vertical" align="center" size="large">
                            <DeleteOutlined style={{ fontSize: '48px', color: '#8c8c8c' }} />
                            <Text type="secondary">Archived Report</Text>
                        </Space>
                    </Content>
                </Layout>
            </Layout>
